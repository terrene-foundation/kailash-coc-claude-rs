...
3. **Existing Solution Discovery**
   ...
   - Review documentation patterns (`.claude/skills/`)
...
- `.claude/skills/15-error-troubleshooting/` — Error patterns and debugging
- `.claude/skills/07-development-guides/` — Development and implementation patterns
