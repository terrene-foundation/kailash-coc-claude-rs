...
1. **Import DataFlow**: `import kailash`
2. **Initialize**: `db = kailash.DataFlow()`
...
builder.add_node("ProductCreateNode", "create_product", {
    "sku": "LAPTOP-001",
    "name": "Gaming Laptop",
...
builder.add_node("SsoSessionReadNode", "read_session_alt", {
