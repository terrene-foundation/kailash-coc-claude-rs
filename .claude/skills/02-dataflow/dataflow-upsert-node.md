...
builder.add_node("UserUpsertNode", "upsert_alice", {
    "where": {"email": "alice@example.com"},
    "conflict_on": ["email"],
...
```python
builder.add_node("UserUpsertNode", "upsert_user", {
...
```python
builder.add_node("ProductUpsertNode", "upsert_product", {
...
```python
builder.add_node("OrderItemUpsertNode", "upsert_item", {
    "where": {
        "order_id": "order-123",
        "product_id": "prod-456"
    },
...
```python
builder.add_node("UserRoleUpsertNode", "assign_role", {
    "where": {
        "user_id": "user-123",
        "role_id": "role-admin"
    },
...
```python
builder.add_node("SensorReadingUpsertNode", "record_reading", {
    "where": {
        "sensor_id": "sensor-A1",
...
builder.add_node("OrderUpsertNode", "create_order", {
...
builder.add_node("UserUpsertNode", "register", {
...
```python
# Update stock by SKU
builder.add_node("ProductUpsertNode", "update_stock", {
...
builder.add_node("ConfigUpsertNode", "set_config", {
...
builder.add_node("TenantConfigUpsertNode", "set_tenant_config", {
    "where": {
...
builder.add_node("UserRoleUpsertNode", "assign", {
...
builder.add_node("OrderItemUpsertNode", "upsert", {
    "where": {
        "order_id": "order-123",
        "product_id": "prod-456"
    },
