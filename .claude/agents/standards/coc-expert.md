...
- Two governing principles:
  - **Framework-First**: Never code from scratch; always check frameworks first (139+ production-ready nodes)
...
- **kailash-expert** - For SDK implementation details (139+ nodes, DataFlow, Nexus, Kaizen)
