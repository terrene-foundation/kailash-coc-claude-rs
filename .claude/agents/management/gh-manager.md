...
7. **Crate Labels**: Tag issues with the affected crate(s) (e.g., `crate:kailash-core`, `crate:kailash-nexus`)
...
3. Add crate labels to indicate which crates are affected
4. Add to project board with correct labels
...
3. Verify `cargo clippy --workspace -- -D warnings` is clean
4. Update GitHub issue with completion details
5. Close GitHub issue with PR reference
6. Archive local todo
...
- Tag with crate labels for affected workspace crates
...
crate:kailash-core
crate:kailash-nodes
crate:kailash-plugin
crate:kailash-capi
crate:kailash-dataflow
crate:kailash-nexus
crate:kailash-kaizen
crate:kailash-enterprise
binding:python
binding:node
binding:wasm
```
...
- Tag crates - label issues with affected workspace crates
